...
| **Wertfeld** | `values` | Eine Wertspalte eines Indikators (z. B. `ai0201`) – eine Zahl oder `null`. `--fields` behält nur die genannten. Bezeichnung und Einheit einer Spalte gibt die CLI nicht aus. |
