...
| **Wertfeld** | `values` | Eine Wertspalte eines Indikators (z. B. `ai0201`) – eine Zahl oder `null`. `--fields` behält nur die genannten. `indicators` listet jede Spalte eines Indikators mit Bezeichnung und Einheit auf. |
